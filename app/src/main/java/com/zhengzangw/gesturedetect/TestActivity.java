...
import com.zhengzangw.gesturedetect.utils.TimestampAxisFormatter;
import com.zhengzangw.gesturedetect.utils.Utils;
...
public class TestActivity extends AppCompatActivity {
    ...
    private boolean startRecInt() {
        if (!recStarted) {
            ...
            assert(sensorEventListener!=null);
    ...
    private void updateUI(long runTime, float timestampMicros, float leftProbability, float rightProbability) {
        ...
        rightProbability -= 0.5; // -0.25..0.25
